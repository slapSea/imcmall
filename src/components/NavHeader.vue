<template>
  ...
  <header class="NavHeader">
          ...
          <div class="confirm-tips">
            ...
            <ul>
              ...
              <li class="regi_form_input noMargin">
                ...
                <input type="password" tabindex="2" name="password" v-model="userPwd" class="regi_login_input" placeholder="Password" @keyup.enter="login">
              </li>
            </ul>
          </div>
    ...
    <div class="md-overlay" v-if="loginModelFlag"></div>
  </header>
</template>
          ...
          checkLogin(){
            axios.get('/users/checkLogin').then((response)=>{
              if(response.data.status=="0"){
                this.nickName = response.data.result
              }
            })
          },
          login(){
