<template>
  <div>
      ...
      <div class="container">
        <div class="checkout-addr">
          ...
          <div class="addr-list-wrap">
            <div class="addr-list">
              <ul>
                <li v-for="(item,index) in addressListLimit" v-bind:class="{'check':checkIndex==index}" @click="checkIndex=index">
                  <dl>
                    <dt>{{item.userName}}</dt>
                  ...
                  <div class="addr-opration addr-del">
                    <a href="javascript:;" class="addr-del-btn" @click="delAddrConfirm(item.addressId)">
                ...
                <li class="addr-new">
                  <div class="add-new-inner" @click="addNewAddr">
                    <i class="icon-add">
            ...
            <div class="shipping-addr-more">
              <a class="addr-more-btn up-down-btn" href="javascript:;" @click="extend" v-bind:class="{'open':limit>3}">
                more
                <i class="i-up-down">
    ...
    <modal :mdShow="isShow" v-on:close="closeModal">
      <p slot="message">
        您确认要删除该地址吗？
      </p>
      <div slot="btnGroup">
        <a class="btn btn--m" href="javascript:;" @click="delAddr">确定</a>
        <a class="btn btn--m" href="javascript:;" @click="isShow=false">取消</a>
      </div>
    </modal>
...
<script>
    ...
    export default {
        ...
        methods:{
          ...
          addNewAddr(){
            axios.post('/users/create').then(response=>{
              let res = response.data
              if (res.status == "0"){
